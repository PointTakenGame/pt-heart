...
// ANTHROPIC_API_KEY= line of HEART_KEY_FILE, else the shared pt-biz operator
// key file. If none of those resolve, the handler returns 503 and the client
// falls back to authored coach lines, so the gym stays playable with no key at all.

// Swapped from Anthropic to Gemini 2026-08-25 (dead key, 401), then back to
// Anthropic 2026-08-26: Steve confirmed the pt-biz operator key works and
// designated it for production. Read only, never printed, never committed.
