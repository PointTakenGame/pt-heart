...
// person who might have been fouled is ruling on it, so two buttons make the
// fast path fast, and the text box is always open underneath because they may
// want to say something instead of, or as well as, pressing a button (Steve,
// 2026-08-26). The note is never required. The buttons are the answer.
...
// The ruling on a suggested foul. Yes and no are both one press, because the
// point of asking is that the answer is cheap; saying no costs nothing and is
// not a wrong answer (soul.md §6 — the possibly-wronged person decides, and the
// suggester is allowed to have been wrong). The box under the buttons is there
// on every one of these, empty and optional: some of what it catches is the
// reason a call was waved off, and that is the part worth keeping.
